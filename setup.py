...
include_dirs = ['.','python', 'third_party/tinyxml2/include', 'third_party/pybind11/include',
    'third_party/cpp_base64/include', 'third_party/zeromq/include', 'third_party/crossguid',
    'third_party/nlohmann/include']

sources = ["python/pydiffarti.cc"]

if _platform == "linux" or _platform == "linux2":
    print("linux")
    libraries = ['dl', 'pthread', 'crossguid', 'uuid', 'zmq', 'tinyxml2']
    # libraries = ['dl', 'pthread', 'uuid']
    CXX_FLAGS += '-D_LINUX '
...
pydiffarti_ext = Extension(
    "pydiffarti",
    sources=sources,
    libraries=libraries,
    library_dirs=['/usr/lib', '/usr/local/lib/', 
                './build/third_party/zeromq/',
                './build/third_party/tinyxml2/',
                './build/third_party/crossguid/'],
    extra_compile_args=CXX_FLAGS.split(),
    include_dirs=include_dirs + ["."])

extensions.append(pydiffarti_ext)
...
setup(
    ...
    package_data={'pydiffarti_data': need_files})
