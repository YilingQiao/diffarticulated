...
struct TinyConstraintSolver {
  ...
  virtual void resolveCollision(
    ...
    if (TinyConstants::getBool(
      cp.m_distance < TinyConstants::zero())) {
      ...
      if (TinyConstants::getBool(
        normal_rel_vel < TinyConstants::zero())) {
        ...
        if (TinyConstants::getBool(
          ...
          if (TinyConstants::getBool(
            friction_impulse_trial < friction_coeffcient * impulse)) {
          ...
          if (TinyConstants::getBool(
            (lateral_rel_vel.length()) > TinyConstants::fraction(1, 10000))) {
