...
struct StanDoubleUtils {
  ...
  static standouble scalar_from_string(const std::string& txt) {
    double result = atof(txt.c_str());
    return standouble(result);
  }
  static inline standouble scalar_from_double(double value) { return standouble(value); }
